...
After adding 1 million elements, the value of B equals to 18, which mean 2^18 = 262144 buckets. When we remove 1 million elements, what's the value of B? Still 18. Hence, the map still contains the same number of buckets.
