...
To avoid this, you can tell your machine to priorities processes as per your requirements.

This priority is called Niceness in Linux.
...
free -g to display output int GB

#### Shell scripting: how to create shell script in Linux/UNIX
